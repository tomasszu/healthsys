...
class DoctorSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('doctors')->insert([
        	...
        	'user_id' => 13,
            'doctor_class' => 5,
            'name' => 'Pētera Kļaviņa infektologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 14,
            'doctor_class' => 1,
            'name' => 'Dr. Liepiņa ģimenes ārsta prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 16,
            'doctor_class' => 2,
            'name' => 'Anastasijas Ābolas otorinolaringologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 19,
            'doctor_class' => 2,
            'name' => 'Alekseja Nurminska otorinolaringologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 20,
            'doctor_class' => 2,
            'name' => 'Patrika Ozola otorinolaringologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 21,
            'doctor_class' => 3,
            'name' => 'Ņikitas Bumbiera dermatologa-venerologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 22,
            'doctor_class' => 4,
            'name' => 'Valērijas Burkānas gastroenterologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 24,
            'doctor_class' => 8,
            'name' => 'Margaritas Svetovas neirologa prakse',
        ...
        DB::table('doctors')->insert([
        	...
        	'user_id' => 25,
            'doctor_class' => 1,
            'name' => 'Dr. Ikala ģimenes ārsta prakse',
